...
* Project File: project4_Patel_nvp0005.cpp
*
* Complile: g++ -std=c++11 project4_Patel_nvp0005.cpp -o p4.out   
* Run: ./p4.out 
* 
* For some reason you need the -std=c++11 flag to compile this code.
*/
...
int main() {
    ...
    #ifdef trivia_quiz
        cout << "*** Welcome to Nikhil's trivia quiz game ***" << endl;
